...
function NavigationMenuList({
  className,
  ...props
}: React.ComponentProps<typeof NavList>) {
  return (
    <NavList
      className={cn(
...
function NavigationMenuTrigger({
  ...
  children,
  ...props
}: React.ComponentProps<typeof NavTrigger>) {
  return (
    <NavTrigger
...
function NavigationMenuViewport({
  className,
  ...props
}: React.ComponentProps<typeof NavViewport>) {
  return (
    <div
      className={cn(
...
function NavigationMenuIndicator({
  className,
  ...props
}: React.ComponentProps<typeof NavIndicator>) {
  return (
    <NavIndicator
      className={cn(
