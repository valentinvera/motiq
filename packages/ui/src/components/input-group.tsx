...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: This wrapper can contain mixed form controls and addons.
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: Addons are grouped with the input without changing form semantics.
    // biome-ignore lint/a11y/useKeyWithClickEvents: Focusing the sibling input is a pointer convenience; the input remains keyboard accessible.
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: Focusing the sibling input from addon clicks is intentional.
    <div
