import { X } from "@motiq/ui/icons/x"
import { Link } from "@tanstack/react-router"

export const Footer = () => {
  return (
    <footer className="border-zinc-800 border-t bg-zinc-950 py-12">
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          <div className="col-span-2 lg:col-span-2">
            <Link
              className="mb-4 flex items-center gap-2 font-bold text-white text-xl tracking-tight"
              to="/"
            >
              <svg
            ...
            <p className="max-w-xs text-sm text-zinc-500">
              Autonomous customer intelligence that monitors feedback 24/7.
              Detect critical signals before they become churn.
            </p>
          </div>

          <div>
            <h3 className="mb-4 font-semibold text-sm text-white">Product</h3>
          ...
          <div>
            <h3 className="mb-4 font-semibold text-sm text-white">Company</h3>
            <ul className="space-y-3 text-sm text-zinc-500">
              <li>
                <Link className="hover:text-lime-400" to="/">
                  About
          ...
          <div>
            <h3 className="mb-4 font-semibold text-sm text-white">Legal</h3>
            <ul className="space-y-3 text-sm text-zinc-500">
              <li>
                <Link className="hover:text-lime-400" to="/">
                  Privacy
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-zinc-900 border-t pt-8 sm:flex-row">
          <p className="text-sm text-zinc-600">
            © {new Date().getFullYear()} Motiq. All rights reserved.
          </p>
