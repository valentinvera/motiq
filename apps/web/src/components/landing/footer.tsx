...
export const Footer = () => {
  return (
    <footer className="relative border-white/10 border-t bg-black pt-24 pb-12">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-24 grid grid-cols-1 gap-12 md:grid-cols-12">
          <div className="md:col-span-4">
            <Link
              className="mb-6 flex items-center gap-2.5 font-bold text-white text-xl tracking-tighter"
              to="/"
            >
              <div className="flex size-8 items-center justify-center rounded-lg border border-white/10 bg-black">
                <svg
          ...
          <div className="grid grid-cols-2 gap-8 md:col-span-8 md:grid-cols-3">
            <div>
              <h3 className="mb-6 font-semibold text-sm text-white uppercase tracking-widest">
                Product
              </h3>
