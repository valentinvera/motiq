...
export const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-zinc-950">
      <div className="relative z-10 mx-auto max-w-7xl border-white/5 border-x border-t">
        <div className="grid grid-cols-1 md:grid-cols-12">
          <div className="border-white/5 border-b p-8 md:col-span-5 md:border-r md:border-b-0 md:p-12">
            <Link
              className="mb-6 flex items-center gap-2.5 font-bold text-white text-xl tracking-tighter"
              to="/"
            >
              <div className="flex h-6 w-6 items-center justify-center rounded bg-lime-400 text-zinc-950">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
            ...
            <p className="max-w-xs text-sm text-zinc-500 leading-relaxed">
              Autonomous customer intelligence monitoring feedback 24/7. Zero
              noise. Just growth.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8 p-8 md:col-span-7 md:grid-cols-3 md:p-12">
            <div>
              <h3 className="mb-6 font-bold text-[10px] text-white uppercase tracking-[0.2em]">
                Product
              </h3>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-white/5 border-t bg-black/20 p-8 md:flex-row md:px-12">
          <span className="font-mono text-[9px] text-zinc-600 uppercase tracking-widest">
            {"© "}
            {new Date().getFullYear()}
            {" Motiq_Inc // Built_for_Scale"}
          </span>
          <div className="flex gap-8 font-bold text-[10px] text-zinc-600 uppercase tracking-tighter">
            <Link
